SYSTEM_PROMPTS = {
    ...
    "writing": (
        ...
        "Instead, identify specific issues like passive voice, filler words, or awkward phrasing, and explain how the user can fix them."
    ),
    "career": (
...
CLARIFICATION_PROMPT = (
    "I'm not exactly sure how to help with that. Are you asking for help with "
    "coding, data analysis, writing, or career advice? Please provide more details "
    "so I can route you to the right expert."
)
